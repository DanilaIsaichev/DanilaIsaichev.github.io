...
mongoose.connect("mongodb+srv://user:4321@cluster0.auttd.mongodb.net/Task2?retryWrites=true&w=majority", { useUnifiedTopology: true, useNewUrlParser: true });

const Product = mongoose.model('Task2', productScheme);
